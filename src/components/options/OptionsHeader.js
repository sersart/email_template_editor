...
const OptionsHeader = ({ block, t, onPropChange }) => {
	const aligns = {
		"left": "0",
		"right": "2",
		"center": "1",
	...
	return (
		<div>
			...
			<div>
				<label>{t("Height")} <input type="text" value={block.options.container.height} onChange={(e) => onPropChange('height', e.target.value, true)} /></label>
			</div>
			<hr />
			<div>
				<label>
...
export default translate('translations')(OptionsHeader);
