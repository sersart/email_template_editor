...
const OptionsPosts = ({ block, t, onPropChange }) => {
	return (
		<div>
			<div>
			...
			<div>
				<label>{t("Height")} <input type="number" value={block.options.elements[2].height} onChange={(e) => onPropChange('height', e.target.value, false, 2)} /></label>
			</div>
			<div>
				<label>{t("Color")} <input type="color" value={block.options.elements[2].color} onChange={(e) => onPropChange('color', e.target.value, false, 2)} /></label>
			</div>
			<div>
				<label>{t("Background")} <input type="color" value={block.options.elements[2].backgroundColor} onChange={(e) => onPropChange('backgroundColor', e.target.value, false, 2)} /></label>
			</div>
			<hr />
			[separator]
			<div>
				<label>{t("Height")} <input type="number" value={block.options.elements[3].height} onChange={(e) => onPropChange('height', e.target.value, false, 3)} /></label>
			</div>
			<div>
				<label>{t("Show separator")} <input type="checkbox" checked={block.options.elements[3].display === ''? 'none': ''} onChange={(e) => onPropChange('display', (block.options.elements[3].display === ''? 'none': ''), false, 3)} /></label>
			</div>
			<div>
				<label>{t("Background")} <input type="color" value={block.options.elements[3].backgroundColor} onChange={(e) => onPropChange('backgroundColor', e.target.value, false, 3)} /></label>
			</div>
			<hr />
			<div>
...
export default translate('translations')(OptionsPosts);
